...
class Candidate {
	...
	void displayCongrats() {
		System.out.println(GREEN+"Congrats " + name + "! This is the correct option."+RESET);
	}

	void displayEncouragement() {
		System.out.println(RED+"Sorry " + name + "! That is not the correct option."+RESET);
	}
}
...
class Question {
	...
	void display50_50Lifeline(Scanner sc, Candidate candidate, int[] prizeAmount) {
	    ...
	    if (chosenAnswer.equals(correctOption)) {
	        ...
	        System.out.println(GREEN+"You've won: " + prizeAmount[0]+RESET); // Display the prize amount
	    } else {
	        candidate.displayEncouragement();
	        System.out.println(RED+"You lost! Total prize: " + prizeAmount[0]+RESET); // Display the total prize amount
	        System.exit(0);
	    }
	}
	...
	public static void main(String[] args) {
		...
		for (Question question : questions) {
		    ...
		    if (question.isAnswerCorrect(selectedOption, candidate)) {
		        ...
		        System.out.println(GREEN+"You've won: " + totalPrize+RESET);
		    } else {
		        System.out.println(RED+"You lost! Total prize: " + totalPrize+RESET);
		        break;
		    }
